            ...
            <Container>
                {
                    user?.role === 'admin' || user?.role === 'organizer'
                        ...
                        <div className="h-[60vh] flex items-center justify-center">
                            <h2 className="text-4xl font-bold text-dark_01 text-center">Your are already {user?.role}. Please go to <Link to='/dashboard' className="text-amber-700">Dashboard</Link></h2>
                        </div>
                        :
                        <div className="p-10 bg-white rounded-md">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                ...
                                <div className="mt-4 flex justify-center">
                                    <button className="bg-amber-700 px-4 py-2 rounded-md text-white uppercase">Submit Request</button>
                                </div>
                            </form>
                        </div>
                }
