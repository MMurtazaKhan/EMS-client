            ...
            <div className="mt-5 md:mt-20 lg:mt-10">
              <form onSubmit={handleSubmit} className="flex justify-center pb-5">
                ...
                <input
                  type="submit"
                  value="Subscribe"
                  className="bg-amber-700 text-white p-3 rounded-r-lg cursor-pointer"
                />
              </form>
              <p className="text-white text-center px-10 hidden lg:flex">
                {" "}
                Your personal data is to be used by the legal entity Fiesta Flex
                Events in order to provide you with the Fiesta Flex Events services
                that you requested, to send you information on Fiesta Flex Events
