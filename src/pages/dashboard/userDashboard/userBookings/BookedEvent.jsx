...
const BookedEvent = () => {
  ...
  const fetchPaymentHistory = async () => {
    const response = await axios.get(
      `https://fiesta-flex.vercel.app/order/${user?.email}`
  ...
  return (
    <div>
      <h2 className="text-center text-amber-700 text-2xl font-semibold mb-4">
        My Bookings
              ...
              <tr key={order._id} className="border-b text-center">
                ...
                <td className="px-4 py-2 ml-2">
                  <button
                    ...
                    className="px-4 py-1.5 flex items-center gap-0.5 text-nowrap text-lg font-semibold rounded bg-amber-700 text-white"
                  >
