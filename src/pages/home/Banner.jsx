        ...
        <div className="flex flex-col justify-center sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          <div className="flex flex-col justify-center text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <h1 className="text-5xl font-bold sm:text-5xl">
              ...
              <span className="text-amber-700">Perfectly</span> Executed Events
            </h1>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-2">
              <button
                ...
                className="px-5 py-3 text-lg font-semibold rounded bg-amber-700 text-white"
              >
                Get Started
              </button>
              <Link
                to="/contact"
                className="px-5 py-3 text-lg font-semibold border border-primary text-amber-700 rounded"
              >
                Contact Us
              </Link>
            </div>
