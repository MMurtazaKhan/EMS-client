            ...
            <div className="flex justify-center items-center w-full h-screen">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="bg-white dark:bg-gray-900 px-10 py-5 rounded-xl w-screen shadow-md max-w-sm">
                        <div className="space-y-4">
                            <div className="text-center space-y-2">
                                ...
                                <small className="text-gray-400 dark:text-gray-200">
                                    Create an account to start using Fiesta Flex
                                </small>
                            </div>
                        ...
                        <button className="mt-4 w-full bg-amber-700 text-white py-2 rounded-md text-md tracking-wide">
                            Sign Up
                        </button>
                        <div>
                            ...
                            <div className="p-5 text-sm text-center">
                                ...
                                <Link
                                    to="/login"
                                    className="font-medium text-amber-700 hover:text-blue-400 dark:text-blue-400 dark:hover:text-blue-300"
                                >
