        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 py-5">
          <div>
            ...
            <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
              At Fiesta Flex Events, we specialize in turning your events into
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="flex items-center justify-center gap-1.5 ">
                  ...
                  <a href="mailto:info@fiestaflex.com">info@fiestaflex.com</a>                  </span>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="md:flex-1 text-gray-700">
                      <a href="tel:021-1298919">021-1298919</a>
                    </span>
                  </Link>
                </li>
        ...
        <div className="mt-12 border-t border-gray-100 py-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
              © {new Date().getFullYear()} Fiesta Flex Events
            </p>
          </div>
        </div>
      </Container>
